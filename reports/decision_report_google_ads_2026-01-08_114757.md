...
action: REDUCE
confidence: 0.249 (LOW)
downside_risk: 0.586 (HIGH)
...
- reason: Downside risk is extreme (0.586 ≥ 0.55). Reduce spend and investigate.
...
- Downside risk spiked to 0.586, above the REDUCE threshold for balanced.
