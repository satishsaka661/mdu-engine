...
action: REDUCE
confidence: 0.247 (LOW)
downside_risk: 0.588 (HIGH)
...
- reason: Downside risk is extreme (0.588 ≥ 0.55). Reduce spend and investigate.
...
- Downside risk spiked to 0.588, above the REDUCE threshold for balanced.
